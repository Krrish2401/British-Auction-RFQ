...
import { ArrowLeft, Clock, Settings, AlertTriangle, RefreshCw } from "lucide-react";
            ...
            <div className="mx-auto max-w-7xl px-4 pb-12 pt-24 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <CountdownTimer
                        ...
                        onExpired={() => { setIsBidWindowExpired(true); void fetchRFQ(); }}
                    />
                </motion.div>
                            ...
                            <div className="theme-card p-5">
                                ...
                                <div className="space-y-3 text-sm">
                                    <div className="flex justify-between">
                                        <span style={{ color: "var(--muted-foreground)" }}>Close Time</span>
                            ...
                            <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
                                <div className="theme-card p-5">
                                    <div className="flex items-center gap-2 mb-4">
                                        ...
                                        <h3 className="text-sm font-semibold" style={{ fontFamily: "var(--font-heading)" }}>Auction Rules</h3>
                                    </div>
