...
import { Plus, ArrowRight, TrendingDown, Clock, FileText, Activity } from "lucide-react";
        ...
        >
            ...
            {isFetching ? (
                ...
                <div className="theme-card py-16 text-center">
                    ...
                    <p className="text-lg font-semibold" style={{ fontFamily: "var(--font-heading)" }}>No RFQs created yet</p>
